    ...
    <footer className="bg-slate-800">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <Link href="/" className="flex items-center">                      
                      <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">AmazonLibre</span>
                  </Link>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">  
                  ...
                  <div>
                      ...
                      <ul className="text-gray-500 dark:text-gray-400 font-medium">
                          <li className="mb-1">
                              <Link href="https://www.amazon.com/-/es/gp/help/customer/display.html?ie=UTF8&nodeId=TnACMrGVghHocjL8KB&ref_=footer_consumer_health_data_privacy" className="hover:underline">Privacy Policy</Link>
                          </li>
                          <li className="mb-1">
                              <Link href="https://www.amazon.com/-/es/gp/help/customer/display.html?nodeId=508088&ref_=footer_cou" className="hover:underline">Terms &amp; Conditions</Link>
                          </li>
                      </ul>
                  </div>
              </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link href="/" className="hover:underline">AmazonLibre™</Link>. All Rights Reserved.
              </span>
              <div className="flex mt-4 sm:justify-center sm:mt-0">
                  <Link href="https://www.facebook.com/Amazon" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                      <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                            <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                        </svg>
                      <span className="sr-only">Facebook page</span>
                  </Link>
                  <Link href="https://discord.com/invite/fulfillment-by-amazon" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                  ...
                  <Link href="https://twitter.com/amazon" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                  ...
                  <Link href="https://github.com/lucastamburlini/amazonLibre" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
